...
You can deploy your site to static site hosting services such as [ZEIT Now](https://zeit.co/now), [GitHub Pages](https://pages.github.com/), [Netlify](https://www.netlify.com/), [Render](https://render.com/static-sites), and [Surge](https://surge.sh/help/getting-started-with-surge). Vobees sites are statically rendered so they work without JavaScript too!

## Deploying to GitHub Pages

Vobees provides a easy way to publish to [GitHub Pages](https://pages.github.com/). Which is hosting that comes for free with every GitHub repository.
...
```jsx {3-6} title="vobees.config.js"
module.exports = {
  ...
...
Surge is a [static web hosting platform](https://surge.sh/help/getting-started-with-surge), it is used to deploy your Vobees project from command line in a minute. Deploying your project to Surge is easy and it is also free (including a custom domain and SSL).
